...
-- Remap for select all inside buffer
vim.keymap.set('n', '<C-a>', 'ggVG', { noremap = true, silent = true })

-- Remap for Navigating bufefrs in 'presentation mode'
...
vim.keymap.set('n', '<leader>bc', '<cmd>%bdelete|edit #|bdelete #<CR>', { desc = '[B]uffer [C]lose others' })
vim.g.netrw_banner = 0 -- Hide the banner

-- Keymap for open file explorer
